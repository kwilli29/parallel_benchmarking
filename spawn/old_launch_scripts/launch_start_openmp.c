...
int main(int argc, char *argv[]){
	...
	//for(int i=0; i < DEPTH; i++){
		realTime = (endtimes[0].tv_sec+ (double)endtimes[0].tv_usec/1000000) - (start_time.tv_sec+(double)start_time.tv_usec/1000000);
		printf("\n Overall Time lso (1) = %lf", realTime);
		...
		printf("\n Overall Time lso (2)  = %lf", realTime);
