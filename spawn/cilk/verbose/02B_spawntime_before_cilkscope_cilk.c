...
int main(int argc, char *argv[]){
	...
	cilk_scope{
        ...
        { clock_gettime(CLOCK_MONOTONIC, &t_end[0]); cilk_spawn spawn_function(); }
		 ...
		 { clock_gettime(CLOCK_MONOTONIC, &t_end[9]); cilk_spawn spawn_function(); } 
		 // 10
		{ clock_gettime(CLOCK_MONOTONIC, &t_end[10]); cilk_spawn spawn_function(); }
		 ...
		 { clock_gettime(CLOCK_MONOTONIC, &t_end[19]); cilk_spawn spawn_function(); }
		 // 20
		...
		{ clock_gettime(CLOCK_MONOTONIC, &t_end[30]); cilk_spawn spawn_function(); }
		 ...
		 { clock_gettime(CLOCK_MONOTONIC, &t_end[39]); cilk_spawn spawn_function(); }
		 // 40
		{ clock_gettime(CLOCK_MONOTONIC, &t_end[40]); cilk_spawn spawn_function(); }
		 ...
		 { clock_gettime(CLOCK_MONOTONIC, &t_end[49]); cilk_spawn spawn_function(); }
		 // 50
		{ clock_gettime(CLOCK_MONOTONIC, &t_end[50]); cilk_spawn spawn_function(); }
		 ...
		 { clock_gettime(CLOCK_MONOTONIC, &t_end[59]); cilk_spawn spawn_function(); }
		 // 60
		{ clock_gettime(CLOCK_MONOTONIC, &t_end[60]); cilk_spawn spawn_function(); }
		 ...
		 { clock_gettime(CLOCK_MONOTONIC, &t_end[69]); cilk_spawn spawn_function(); }
		 // 70
		{ clock_gettime(CLOCK_MONOTONIC, &t_end[70]); cilk_spawn spawn_function(); }
		 ...
		 { clock_gettime(CLOCK_MONOTONIC, &t_end[79]); cilk_spawn spawn_function(); }
		 // 80
		{ clock_gettime(CLOCK_MONOTONIC, &t_end[80]); cilk_spawn spawn_function(); }
		 ...
		 { clock_gettime(CLOCK_MONOTONIC, &t_end[89]); cilk_spawn spawn_function(); }
		 // 90
		{ clock_gettime(CLOCK_MONOTONIC, &t_end[90]); cilk_spawn spawn_function(); }
		 ...
		 { clock_gettime(CLOCK_MONOTONIC, &t_end[99]); cilk_spawn spawn_function(); }
		 // 100
		{ clock_gettime(CLOCK_MONOTONIC, &t_end[100]); cilk_spawn spawn_function(); }
		 ...
		 { clock_gettime(CLOCK_MONOTONIC, &t_end[109]); cilk_spawn spawn_function(); }
		 // 110
		{ clock_gettime(CLOCK_MONOTONIC, &t_end[110]); cilk_spawn spawn_function(); }
		 ...
		 { clock_gettime(CLOCK_MONOTONIC, &t_end[119]); cilk_spawn spawn_function(); }
		 // 120
		{ clock_gettime(CLOCK_MONOTONIC, &t_end[120]); cilk_spawn spawn_function(); }
		 ...
		 { clock_gettime(CLOCK_MONOTONIC, &t_end[129]); cilk_spawn spawn_function(); }
		 // 130
		{ clock_gettime(CLOCK_MONOTONIC, &t_end[130]); cilk_spawn spawn_function(); }
		 ...
		 { clock_gettime(CLOCK_MONOTONIC, &t_end[139]); cilk_spawn spawn_function(); }
		 // 140
		{ clock_gettime(CLOCK_MONOTONIC, &t_end[140]); cilk_spawn spawn_function(); }
		 ...
		 { clock_gettime(CLOCK_MONOTONIC, &t_end[149]); cilk_spawn spawn_function(); }
		 // 150
		{ clock_gettime(CLOCK_MONOTONIC, &t_end[150]); cilk_spawn spawn_function(); }
		 ...
		 { clock_gettime(CLOCK_MONOTONIC, &t_end[159]); cilk_spawn spawn_function(); }
		 // 160
		{ clock_gettime(CLOCK_MONOTONIC, &t_end[160]); cilk_spawn spawn_function(); }
		 ...
		 { clock_gettime(CLOCK_MONOTONIC, &t_end[169]); cilk_spawn spawn_function(); }
		 // 170
		{ clock_gettime(CLOCK_MONOTONIC, &t_end[170]); cilk_spawn spawn_function(); }
		 ...
		 { clock_gettime(CLOCK_MONOTONIC, &t_end[179]); cilk_spawn spawn_function(); }
		 // 180
		{ clock_gettime(CLOCK_MONOTONIC, &t_end[180]); cilk_spawn spawn_function(); }
		 ...
		 { clock_gettime(CLOCK_MONOTONIC, &t_end[189]); cilk_spawn spawn_function(); }
		 // 190
		{ clock_gettime(CLOCK_MONOTONIC, &t_end[190]); cilk_spawn spawn_function(); }
		 ...
		 { clock_gettime(CLOCK_MONOTONIC, &t_end[199]); cilk_spawn spawn_function(); }
		 // 200
		{ clock_gettime(CLOCK_MONOTONIC, &t_end[200]); cilk_spawn spawn_function(); }
		 ...
		 { clock_gettime(CLOCK_MONOTONIC, &t_end[209]); cilk_spawn spawn_function(); }
		 // 210
		{ clock_gettime(CLOCK_MONOTONIC, &t_end[210]); cilk_spawn spawn_function(); }
		 ...
		 { clock_gettime(CLOCK_MONOTONIC, &t_end[219]); cilk_spawn spawn_function(); }
		 // 220
		{ clock_gettime(CLOCK_MONOTONIC, &t_end[220]); cilk_spawn spawn_function(); }
		 ...
		 { clock_gettime(CLOCK_MONOTONIC, &t_end[229]); cilk_spawn spawn_function(); }
		 // 230
		{ clock_gettime(CLOCK_MONOTONIC, &t_end[230]); cilk_spawn spawn_function(); }
		 ...
		 { clock_gettime(CLOCK_MONOTONIC, &t_end[239]); cilk_spawn spawn_function(); }
		 // 240
		{ clock_gettime(CLOCK_MONOTONIC, &t_end[240]); cilk_spawn spawn_function(); }
		 ...
		 { clock_gettime(CLOCK_MONOTONIC, &t_end[249]); cilk_spawn spawn_function(); }
		 // 250
		{ clock_gettime(CLOCK_MONOTONIC, &t_end[250]); cilk_spawn spawn_function(); }
		 ...
		 { clock_gettime(CLOCK_MONOTONIC, &t_end[259]); cilk_spawn spawn_function(); }
		 // 260
		{ clock_gettime(CLOCK_MONOTONIC, &t_end[260]); cilk_spawn spawn_function(); }
		 ...
		 { clock_gettime(CLOCK_MONOTONIC, &t_end[269]); cilk_spawn spawn_function(); }
		 // 270
		{ clock_gettime(CLOCK_MONOTONIC, &t_end[270]); cilk_spawn spawn_function(); }
		 { clock_gettime(CLOCK_MONOTONIC, &t_end[271]); cilk_spawn spawn_function(); }
		 /* { clock_gettime(CLOCK_MONOTONIC, &t_end[272]); cilk_spawn spawn_function(); }
		 ...
		 { clock_gettime(CLOCK_MONOTONIC, &t_end[279]); cilk_spawn spawn_function(); }
		 // 280
		 ...
		 { clock_gettime(CLOCK_MONOTONIC, &t_end[289]); cilk_spawn spawn_function(); }
		 // 290
		 ...
		 { clock_gettime(CLOCK_MONOTONIC, &t_end[299]); cilk_spawn spawn_function(); }
		 // 300
