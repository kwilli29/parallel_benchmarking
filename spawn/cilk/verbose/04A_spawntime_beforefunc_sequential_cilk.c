...
int main(int argc, char *argv[]){
    ...
    clock_gettime(CLOCK_MONOTONIC, &t_start[0]); t_end[0] = cilk_spawn spawn_function(); // 1 // Take time stamp before each spawn
		clock_gettime(CLOCK_MONOTONIC, &t_start[1]); t_end[1] = cilk_spawn spawn_function(); // 2
		clock_gettime(CLOCK_MONOTONIC, &t_start[2]); t_end[2] = cilk_spawn spawn_function(); // 3
		clock_gettime(CLOCK_MONOTONIC, &t_start[3]); t_end[3] = cilk_spawn spawn_function(); // 4

		clock_gettime(CLOCK_MONOTONIC, &t_start[4]); t_end[4] = cilk_spawn spawn_function(); // 5
		clock_gettime(CLOCK_MONOTONIC, &t_start[5]); t_end[5] = cilk_spawn spawn_function();
		clock_gettime(CLOCK_MONOTONIC, &t_start[6]); t_end[6] = cilk_spawn spawn_function(); // 7
		clock_gettime(CLOCK_MONOTONIC, &t_start[7]); t_end[7] = cilk_spawn spawn_function(); // 8
		clock_gettime(CLOCK_MONOTONIC, &t_start[8]); t_end[8] = cilk_spawn spawn_function(); // 9
		clock_gettime(CLOCK_MONOTONIC, &t_start[9]); t_end[9] = cilk_spawn spawn_function(); // if(NCILK-10 <= 0) { goto end; } // 10
		...
		clock_gettime(CLOCK_MONOTONIC, &t_start[14]); t_end[14] = cilk_spawn spawn_function(); // 15
		clock_gettime(CLOCK_MONOTONIC, &t_start[15]); t_end[15] = cilk_spawn spawn_function(); // 16
		clock_gettime(CLOCK_MONOTONIC, &t_start[16]); t_end[16] = cilk_spawn spawn_function(); // 17
		...
		clock_gettime(CLOCK_MONOTONIC, &t_start[19]); t_end[19] = cilk_spawn spawn_function(); // if(NCILK-20 <= 0) { goto end; } // 20
		...
		clock_gettime(CLOCK_MONOTONIC, &t_start[29]); t_end[29] = cilk_spawn spawn_function(); // if(NCILK-30 <= 0) { goto end; } // 30

		clock_gettime(CLOCK_MONOTONIC, &t_start[30]); t_end[30] = cilk_spawn spawn_function(); // 31
		clock_gettime(CLOCK_MONOTONIC, &t_start[31]); t_end[31] = cilk_spawn spawn_function(); // 32
		clock_gettime(CLOCK_MONOTONIC, &t_start[32]); t_end[32] = cilk_spawn spawn_function(); // 33
		...
		clock_gettime(CLOCK_MONOTONIC, &t_start[39]); t_end[39] = cilk_spawn spawn_function(); // if(NCILK-40 <= 0) { goto end; } // 40
		...
		clock_gettime(CLOCK_MONOTONIC, &t_start[49]); t_end[49] = cilk_spawn spawn_function(); // if(NCILK-50 <= 0) { goto end; } // 50
		...
		clock_gettime(CLOCK_MONOTONIC, &t_start[59]); t_end[59] = cilk_spawn spawn_function(); // if(NCILK-60 <= 0) { goto end; } // 60
		...
		clock_gettime(CLOCK_MONOTONIC, &t_start[62]); t_end[62] = cilk_spawn spawn_function(); // 63
		clock_gettime(CLOCK_MONOTONIC, &t_start[63]); t_end[63] = cilk_spawn spawn_function(); // 64

		clock_gettime(CLOCK_MONOTONIC, &t_start[64]); t_end[64] = cilk_spawn spawn_function(); // 65
		...
		clock_gettime(CLOCK_MONOTONIC, &t_start[69]); t_end[69] = cilk_spawn spawn_function(); // if(NCILK-70 <= 0) { goto end; } // 70
		...
		clock_gettime(CLOCK_MONOTONIC, &t_start[79]); t_end[79] = cilk_spawn spawn_function(); // if(NCILK-80 <= 0) { goto end; } // 80
		...
		clock_gettime(CLOCK_MONOTONIC, &t_start[89]); t_end[89] = cilk_spawn spawn_function(); // if(NCILK-90 <= 0) { goto end; } // 90
		...
		clock_gettime(CLOCK_MONOTONIC, &t_start[99]); t_end[99] = cilk_spawn spawn_function(); //  if(NCILK-100 <= 0) { goto end; } // 100
		...
		clock_gettime(CLOCK_MONOTONIC, &t_start[109]); t_end[109] = cilk_spawn spawn_function(); // if(NCILK-110 <= 0) { goto end; } // 110
		...
		clock_gettime(CLOCK_MONOTONIC, &t_start[119]); t_end[119] = cilk_spawn spawn_function(); // if(NCILK-120 <= 0) { goto end; } // 120
		...
		clock_gettime(CLOCK_MONOTONIC, &t_start[126]); t_end[126] = cilk_spawn spawn_function(); // 127
		clock_gettime(CLOCK_MONOTONIC, &t_start[127]); t_end[127] = cilk_spawn spawn_function(); // 128

		clock_gettime(CLOCK_MONOTONIC, &t_start[128]); t_end[128] = cilk_spawn spawn_function(); // 129
		clock_gettime(CLOCK_MONOTONIC, &t_start[129]); t_end[129] = cilk_spawn spawn_function(); // if(NCILK-130 <= 0) { goto end; } // 130
		...
		clock_gettime(CLOCK_MONOTONIC, &t_start[139]); t_end[139] = cilk_spawn spawn_function(); // if(NCILK-140 <= 0) { goto end; } // 140
		...
		clock_gettime(CLOCK_MONOTONIC, &t_start[149]); t_end[149] = cilk_spawn spawn_function(); // if(NCILK-150 <= 0) { goto end; } // 150
		...
		clock_gettime(CLOCK_MONOTONIC, &t_start[159]); t_end[159] = cilk_spawn spawn_function(); // if(NCILK-160 <= 0) { goto end; } // 160
		...
		clock_gettime(CLOCK_MONOTONIC, &t_start[169]); t_end[169] = cilk_spawn spawn_function(); // if(NCILK-170 <= 0) { goto end; } // 170
		...
		clock_gettime(CLOCK_MONOTONIC, &t_start[179]); t_end[179] = cilk_spawn spawn_function(); // if(NCILK-180 <= 0) { goto end; } // 180
		...
		clock_gettime(CLOCK_MONOTONIC, &t_start[189]); t_end[189] = cilk_spawn spawn_function(); // if(NCILK-190 <= 0) { goto end; } // 190
		...
		clock_gettime(CLOCK_MONOTONIC, &t_start[199]); t_end[199] = cilk_spawn spawn_function(); // if(NCILK-200 <= 0) { goto end; } // 200
		...
		clock_gettime(CLOCK_MONOTONIC, &t_start[209]); t_end[209] = cilk_spawn spawn_function(); // if(NCILK-210 <= 0) { goto end; } // 210
		...
		clock_gettime(CLOCK_MONOTONIC, &t_start[219]); t_end[219] = cilk_spawn spawn_function(); // if(NCILK-220 <= 0) { goto end; } // 220
		...
		clock_gettime(CLOCK_MONOTONIC, &t_start[229]); t_end[229] = cilk_spawn spawn_function(); // if(NCILK-230 <= 0) { goto end; } // 230
		...
		clock_gettime(CLOCK_MONOTONIC, &t_start[239]); t_end[239] = cilk_spawn spawn_function(); // if(NCILK-240 <= 0) { goto end; } // 240
		...
		clock_gettime(CLOCK_MONOTONIC, &t_start[249]); t_end[249] = cilk_spawn spawn_function(); // if(NCILK-250 <= 0) { goto end; } // 250
		...
		clock_gettime(CLOCK_MONOTONIC, &t_start[254]); t_end[254] = cilk_spawn spawn_function(); // 255
		clock_gettime(CLOCK_MONOTONIC, &t_start[255]); t_end[255] = cilk_spawn spawn_function(); // 256
		clock_gettime(CLOCK_MONOTONIC, &t_start[256]); t_end[256] = cilk_spawn spawn_function(); // 257
		...
		clock_gettime(CLOCK_MONOTONIC, &t_start[259]); t_end[259] = cilk_spawn spawn_function(); // if(NCILK-260 <= 0) { goto end; } // 260
		...
		clock_gettime(CLOCK_MONOTONIC, &t_start[269]); t_end[269] = cilk_spawn spawn_function(); // if(NCILK-270 <= 0) { goto end; } // 270

		clock_gettime(CLOCK_MONOTONIC, &t_start[270]); t_end[270] = cilk_spawn spawn_function(); // 271
		clock_gettime(CLOCK_MONOTONIC, &t_start[271]); t_end[271] = cilk_spawn spawn_function(); // 272
		/*clock_gettime(CLOCK_MONOTONIC, &t_start[272]); t_end[272] = cilk_spawn spawn_function(); // 273
		...
		clock_gettime(CLOCK_MONOTONIC, &t_start[279]); t_end[279] = cilk_spawn spawn_function(); // if(NCILK-280 <= 0) { goto end; } // 280
		...
		clock_gettime(CLOCK_MONOTONIC, &t_start[289]); t_end[289] = cilk_spawn spawn_function(); // if(NCILK-290 <= 0) { goto end; } // 290
		...
		clock_gettime(CLOCK_MONOTONIC, &t_start[299]); t_end[299] = cilk_spawn spawn_function(); // if(NCILK-300 <= 0) { goto end; } // 300
