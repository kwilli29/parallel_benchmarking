...
int main(int argc, char *argv[]){	
	...
	cilk_scope {
		...
		{ clock_gettime(CLOCK_MONOTONIC, &t_start[260]); t_end[260] = cilk_spawn spawn_function(); }
		 ...
		 // 270
		{ clock_gettime(CLOCK_MONOTONIC, &t_start[270]); t_end[270] = cilk_spawn spawn_function(); }
		 { clock_gettime(CLOCK_MONOTONIC, &t_start[271]); t_end[271] = cilk_spawn spawn_function(); }
		 /* { clock_gettime(CLOCK_MONOTONIC, &t_start[272]); t_end[272] = cilk_spawn spawn_function(); }
		 ...
		 { clock_gettime(CLOCK_MONOTONIC, &t_start[279]); t_end[279] = cilk_spawn spawn_function(); }
		 // 280
		 ...
		 { clock_gettime(CLOCK_MONOTONIC, &t_start[289]); t_end[289] = cilk_spawn spawn_function(); }
		 // 290
		 ...
		 { clock_gettime(CLOCK_MONOTONIC, &t_start[299]); t_end[299] = cilk_spawn spawn_function(); }
		 // 300
