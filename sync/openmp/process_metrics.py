...
def main():
    ...
    if len(sys.argv) > 5:
        ...
        if flag == '0': # neither
            ...
            if sys.argv[3] == '4': long_tpts(sys.argv[2],sys.argv[4],sys.argv[1])
            else: short_tpts(sys.argv[2], sys.argv[4],sys.argv[1])
        elif flag == '2': # just overhead
            if sys.argv[3] == '4': long_overhead(sys.argv[2],sys.argv[4],sys.argv[1])
            else: short_overhead(sys.argv[2], sys.argv[4],sys.argv[1])
        else: # both
            if sys.argv[3] == '4':
